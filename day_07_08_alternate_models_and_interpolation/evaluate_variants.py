...
def main():
    ...
    # 1. Baseline
    wer_b, cer_b, ser_b, mse_b = run_variant_eval("baseline", lgb_upscaler, "day_07_08_alternate_models_and_interpolation/wer_baseline.txt", device)
    results["baseline"] = (wer_b, cer_b, ser_b, mse_b)
    
    # 2. Variant 1
    wer_v1, cer_v1, ser_v1, mse_v1 = run_variant_eval("variant1", lgb_upscaler, "day_07_08_alternate_models_and_interpolation/wer_variant1.txt", device)
    results["variant1"] = (wer_v1, cer_v1, ser_v1, mse_v1)
    
    # 3. Variant 2
    wer_v2, cer_v2, ser_v2, mse_v2 = run_variant_eval("variant2", lgb_upscaler, "day_07_08_alternate_models_and_interpolation/wer_variant2.txt", device)
    results["variant2"] = (wer_v2, cer_v2, ser_v2, mse_v2)
    
    # 4. Variant 3
    wer_v3, cer_v3, ser_v3, mse_v3 = run_variant_eval("variant3", lgb_upscaler, "day_07_08_alternate_models_and_interpolation/wer_variant3.txt", device)
    results["variant3"] = (wer_v3, cer_v3, ser_v3, mse_v3)
    
    # 5. Variant 4 (Combined Pre & Post)
    wer_v4, cer_v4, ser_v4, mse_v4 = run_variant_eval("variant4", lgb_upscaler, "day_07_08_alternate_models_and_interpolation/wer_variant4.txt", device)
