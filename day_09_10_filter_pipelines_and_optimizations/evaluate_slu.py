...
def main():
    device = "cpu"
    original_wer_file = "day_04_05_stag_recreation/results/slu_baseline_paper/1235/wer_test_subset_original.txt"
    stacking_wer_file = "day_04_05_stag_recreation/results/slu_baseline_paper/1235/wer_test_subset_stacking.txt"
    ...
    with open("day_09_10_filter_pipelines_and_optimizations/slu_evaluation_results.txt", "w") as f:
