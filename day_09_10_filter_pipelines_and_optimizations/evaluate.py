...
def evaluate_reconstruction():
    ...
    teacher_ckpt = 'models/stag/teacher_model.pt'
    student_ckpt = 'models/stag/student_model.pt'
    ...
    import pickle
    os.makedirs("models/stealthy_imu", exist_ok=True)
    with open("models/stealthy_imu/stacking_upscaler.pkl", "wb") as f:
        pickle.dump(stacking_upscaler, f)
    print("Saved trained StackingUpscaler to models/stealthy_imu/stacking_upscaler.pkl")
    ...
    with open("day_09_10_filter_pipelines_and_optimizations/evaluation_results.txt", "w") as f:
